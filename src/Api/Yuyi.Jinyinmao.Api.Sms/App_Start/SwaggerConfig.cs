...
// Author           : Siqi Lu
// Created          : 2015-04-19  12:42 AM
//
// Last Modified By : Siqi Lu
// Last Modified On : 2015-04-19  12:46 AM
// ***********************************************************************
// <copyright file="SwaggerConfig.cs" company="Shanghai Yuyi">
    ...
    public class SwaggerConfig
    {
        ...
        public static void Register() => GlobalConfiguration.Configuration
            .EnableSwagger("docs/{apiVersion}", c =>
            {
                ...
                //
                c.SingleApiVersion("v1", "Api Document of sms.api.jinyinmao.com.cn");
                ...
                //
                c.IncludeXmlComments(Path.Combine(HttpRuntime.AppDomainAppPath, "bin", "Yuyi.Jinyinmao.Api.Sms.XML"));
