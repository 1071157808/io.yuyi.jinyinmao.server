...
// Author           : Siqi Lu
// Created          : 2015-05-11  12:34 AM
//
// Last Modified By : Siqi Lu
// Last Modified On : 2015-05-11  12:41 AM
// ***********************************************************************
// <copyright file="JBYProductRequest.cs" company="Shanghai Yuyi Mdt InfoTech Ltd.">
...
namespace Yuyi.Jinyinmao.Api.Models.BackOffice
{
    ...
    ///     JBYProductRequest.
    /// </summary>
    public class JBYProductRequest : IRequest
    {
        /// <summary>
        ///     第一份协议内容，一般为委托协议内容
        /// </summary>
        ...
        ///     最大融资额度，以“分”为单位
        /// </summary>
        [Required, Range(1, int.MaxValue), JsonProperty("financingSumCount")]
