...
// Author           : Siqi Lu
// Created          : 2015-04-29  7:15 PM
//
// Last Modified By : Siqi Lu
// Last Modified On : 2015-05-11  1:25 AM
// ***********************************************************************
...
namespace Yuyi.Jinyinmao.Domain.Dtos
{
    ...
    ///     RegularProductEx.
    /// </summary>
    public static class RegularProductEx
    {
        /// <summary>
        ///     To the information.
        /// </summary>
        ...
        public static RegularProductInfo ToInfo(this RegularProduct product)
        {
            return new RegularProductInfo
            {
                EndSellTime = product.EndSellTime,
                FinancingSumAmount = product.FinancingSumAmount,
                Info = JsonConvert.DeserializeObject<Dictionary<string, object>>(product.Info),
                IssueNo = product.IssueNo,
                IssueTime = product.IssueTime,
                PaidAmount = product.FinancingSumAmount,
                PledgeNo = product.PledgeNo,
                ProductCategory = product.ProductCategory,
                ProductId = Guid.ParseExact(product.ProductIdentifier, "N"),
                ProductName = product.ProductName,
                ProductNo = product.ProductNo,
                Repaid = product.Repaid,
                RepaidTime = product.RepaidTime,
                ...
                ValueDateMode = product.ValueDateMode,
                Yield = product.Yield
            };
        }
    }
