...
// Author           : Siqi Lu
// Created          : 2015-05-03  9:59 PM
//
// Last Modified By : Siqi Lu
// Last Modified On : 2015-05-04  12:22 AM
// ***********************************************************************
// <copyright file="DepositFromYilianResulted.cs" company="Shanghai Yuyi">
...
{
    /// <summary>
    ///     DepositFromYilianResulted.
    /// </summary>
    [Immutable]
    public class DepositFromYilianResulted : Event
    {
        /// <summary>
        ///     取现金额，以“分”为单位
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the channal code.
        /// </summary>
        /// <value>The channal code.</value>
        public int ChannalCode { get; set; }
