// FileInformation: nyanya/nyanya.Cat/SettlingProductInfoResponse.cs
// CreatedTime: 2014/08/29   2:51 PM
// LastUpdatedTime: 2014/09/01   10:51 AM
...
namespace nyanya.Cat.Models
{
    ...
    internal static class SettlingProductInfoExtensions
    {
        ...
        internal static SettlingProductInfoResponse ToSettlingProductInfoResponse(this Xingye.Domain.Orders.Services.DTO.SettlingProductInfo info)
        {
            return new SettlingProductInfoResponse
            {
                ExtraInterest = decimal.Round(info.ExtraInterest, 2),
                ...
                ProductNo = info.ProductNo,
                ProductNumber = info.ProductNumber,
                ProductType = (ProductType)info.ProductType,
                SettleDate = info.SettleDate.ToMeowFormat(),
