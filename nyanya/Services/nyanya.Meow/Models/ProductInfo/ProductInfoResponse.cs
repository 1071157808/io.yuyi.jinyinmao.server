// FileInformation: nyanya/nyanya.Meow/ProductInfoResponse.cs
...
namespace nyanya.Meow.Models
{
    ...
    {
        internal static BAProductInfoResponse ToProductInfoResponse(this ProductWithSaleInfo<ProductInfo> info)
        {
