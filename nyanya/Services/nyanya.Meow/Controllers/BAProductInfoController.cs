// FileInformation: nyanya/nyanya.Meow/BAProductInfoController.cs
...
namespace nyanya.Meow.Controllers
{
    ...
    public class BAProductInfoController : ApiController
    {
        ...
        /// </returns>
        [HttpGet, Route("Index"), Route("Index/{category:int=10}")]
        [RangeFilter("category", 10)]
        [ResponseType(typeof(List<BAProductInfoResponse>))]
        public async Task<IHttpActionResult> Index(int category=10)
        {
            ...
            IList<ProductWithSaleInfo<BAProductInfo>> infos = await this.baProductInfoService.GetTopProductWithSaleInfosAsync(6, productCategory);
