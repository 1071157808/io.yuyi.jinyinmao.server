// FileInformation: nyanya/nyanya.Meow/TAProductInfoController.cs
// CreatedTime: 2014/09/09   9:21 AM
// LastUpdatedTime: 2014/09/18   10:06 AM
...
namespace nyanya.Meow.Controllers
{
    ...
    public class TAProductInfoController : ApiControllerBase
    {
        ...
        {
            IPaginatedDto<ProductWithSaleInfo<TAProductInfo>> model = await this.taProductInfoService.GetProductWithSaleInfosAsync(number);
        ...
        {
            ProductWithSaleInfo<TAProductInfo> info = await this.taProductInfoService.GetTopProductWithSaleInfoAsync();
            //if (info == null)
            //{
            //    return this.NotFound();
            //}
