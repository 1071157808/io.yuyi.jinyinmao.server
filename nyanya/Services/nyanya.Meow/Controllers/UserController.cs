...
namespace nyanya.Meow.Controllers
{
    ...
    public class UserController : ApiControllerBase
    {
        ...
        {
            //Cat.Domain.Users.Services.DTO.AddBankCardResult
        ...
        public async Task<IHttpActionResult> SignUp(SignUpRequest request)
        {
            ...
            string userId = await this.userService.GetSignUpUserId(result.Cellphone);
            if (userId.Equals(""))
            {
        ...
        private async Task<SignInResult> SignInAsync(string loginName, string password)
        {
            ...
            if (signInResult.Successful)
            {
                ...
                DateTime expiry = DateTime.Now.AddDays(14);
