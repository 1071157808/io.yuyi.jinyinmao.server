// FileInformation: nyanya/nyanya.Meow/TokenAuthorize.cs
// CreatedTime: 2014/08/29   2:42 PM
...
namespace nyanya.Meow.Filters
{
    ...
    public class TokenAuthorizeAttribute : OrderedActionFilterAttribute
    {
        ...
        private bool IsValid(HttpActionContext actionContext, out string newToken)
        {
            ...
            if (this.RefreshToken)
            {
                DateTime newExpiryTime = DateTime.Now.AddDays(14);
