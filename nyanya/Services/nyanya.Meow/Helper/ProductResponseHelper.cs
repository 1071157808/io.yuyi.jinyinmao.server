...
// Last Modified On : 2015-04-02  11:47 PM
// ***********************************************************************
...
namespace nyanya.Meow.Helper
{
    internal static class ProductResponseHelper
    {
        ...
        internal static ProductShowingStatus GetProductShowingStatus(ZCBProductInfo info, int availableShareCount,
            int payingShareCount)
        {
            ...
            if ((info.StartSellTime >= DateTime.Now && info.EndSellTime <= DateTime.Now && availableShareCount == 0 &&
                 payingShareCount == 0) || (info.EndSellTime < DateTime.Now))
                return ProductShowingStatus.Finished;
