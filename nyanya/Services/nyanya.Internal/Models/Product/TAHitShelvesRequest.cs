...
// Last Modified On : 2015-04-29  7:03 PM
// ***********************************************************************
// <copyright file="TAHitShelvesRequest.cs" company="Shanghai Yuyi">
...
namespace nyanya.Internal.Models
{
    ...
    public class TAHitShelvesRequest : IRequestModel
    {
        ...
        ///     担保方式
        /// </summary>
        [AvailableValues(GuaranteeMode.Bank, GuaranteeMode.Company, GuaranteeMode.Group, GuaranteeMode.GuaranteeCompany, GuaranteeMode.ListedGroup, GuaranteeMode.StateEnterprise, GuaranteeMode.StateguaranteeCompany, GuaranteeMode.PartStateguaranteeCompany, GuaranteeMode.Bankguarantee, GuaranteeMode.Jinyinmao)]
    ...
    internal static partial class HitShelvesRequestExtensions
    {
        internal static LaunchTAProduct ToLaunchTAProduct(this TAHitShelvesRequest request)
        {
            return new LaunchTAProduct
            {
                ...
                GuaranteeMode = request.GuaranteeMode,
                ...
                ProductCategory = request.ProductCategory != ProductCategory.SHIBING ? ProductCategory.JINYINMAO : request.ProductCategory
            };
        }
    }
}
