// FileInformation: nyanya/nyanya.Xingye/UserInfoController.cs
...
namespace nyanya.Xingye.Controllers
{
    ...
    public class UserInfoController : XingyeApiControllerBase
    {
        ...
        public UserInfoController(IUserInfoService userInfoService, IOrderInfoService orderInfoService, IUserService userService)
        {
        ...
        public async Task<IHttpActionResult> Info()
        {
            ...
            bool HasLoginPwd = await this.userService.HasLoginPwd(this.CurrentUser.Cellphone);
            return this.Ok(userInfo.ToUserInfoResponse(HasLoginPwd));
        }
