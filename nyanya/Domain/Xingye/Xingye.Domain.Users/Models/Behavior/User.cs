// FileInformation: nyanya/Xingye.Domain.Users/User.cs
...
namespace Xingye.Domain.Users.Models
{
    public partial class User
    {
        ...
        /// <summary>
        ///     Temp Signs up asynchronous.
        /// </summary>
        /// <param name="command">The command.</param>
        /// <returns></returns>
        public async Task TempSignUpAsync(TempRegisterANewUser command)
        {
            string salt = this.UserIdentifier;
            using (UserContext context = new UserContext())
            {
                this.Cellphone = command.Cellphone;
                this.IdentificationCode = command.IdentificionCode;
                this.UserLoginInfo = this.BuidUserLoginInfo(command.Password, command.Cellphone, salt);
                this.UserType = command.UserType;
                await context.SaveAsync(this);
            }
        }
