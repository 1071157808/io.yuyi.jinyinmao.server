// FileInformation: nyanya/Cqrs.Domain.Order/BAOrderInfoMap.cs
...
{
    internal class BAOrderInfoMap : EntityTypeConfiguration<BAOrderInfo>
    {
        internal BAOrderInfoMap()
        {
            // Primary Key
            this.HasKey(t => t.OrderIdentifier);

            // Table & Column Mappings
            this.ToTable("AllBAOrderInfo", "dbo");
