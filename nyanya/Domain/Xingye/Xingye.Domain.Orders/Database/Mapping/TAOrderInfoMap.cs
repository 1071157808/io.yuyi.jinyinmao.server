// FileInformation: nyanya/Cqrs.Domain.Order/TAOrderInfoMap.cs
...
{
    internal class TAOrderInfoMap : EntityTypeConfiguration<TAOrderInfo>
    {
        internal TAOrderInfoMap()
        {
            // Primary Key
            this.HasKey(t => t.OrderIdentifier);

            // Table & Column Mappings
            this.ToTable("AllTAOrderInfo", "dbo");
