...
namespace Cat.Domain.Products.Database.Mapping
{
    internal class ProductMap : EntityTypeConfiguration<Product>
    {
        ...
        internal ProductMap()
        {
            ...
            this.Map(m => m.ToTable("Products", "dbo")).Map<BankAcceptanceProduct>(m => m.ToTable("BankAcceptanceProducts", "dbo")).Map<TradeAcceptanceProduct>(m => m.ToTable("TradeAcceptanceProducts", "dbo")).Map<ZCBProduct>(m => m.ToTable("ZCBProducts", "dbo"));
        }
