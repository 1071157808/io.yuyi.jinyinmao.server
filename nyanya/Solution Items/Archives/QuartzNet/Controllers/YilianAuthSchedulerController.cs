...
{
    [RoutePrefix("YilianAuthScheduler")]
    public class YilianAuthSchedulerController : ApiControllerBase
    {
        ...
        /// The schduler MGR
        /// </summary>
        public readonly DefaultSchdulerMgr schdulerMgr = SchedulerConfig.SetYilianAuthSchdulerMgr;
        ...
        {
            //schdulerMgr.ExecuteJobOnce();
            schdulerMgr.ExecuteJobOnceByTrigger<YilianAuthJob>();
        }
        ...
        //        public void SchdulerShutdown()
        //        {
        //            schdulerMgr.Shutdown(true);
        //        }
    }
}