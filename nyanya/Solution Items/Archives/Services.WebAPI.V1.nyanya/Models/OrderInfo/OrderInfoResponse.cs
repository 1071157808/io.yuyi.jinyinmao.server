// FileInformation: nyanya/Services.WebAPI.V1.nyanya/OrderInfoResponse.cs
// CreatedTime: 2014/08/10   1:23 PM
// LastUpdatedTime: 2014/08/16   4:42 PM

using System;
using System.Linq;
using Cqrs.Commands.Orders;
    ...
    internal static partial class OrderInfoExtensions
    {
        ...
        internal static OrderInfoResponse ToOrderInfoResponse(this OrderInfo order)
        {
            OrderInfoResponse orderInfoResponse = new OrderInfoResponse
            {
                ...
                InvestorCredentialNo = CredentialHelper.GetHidenCredentialNo(order.InvestorCredentialNo),
