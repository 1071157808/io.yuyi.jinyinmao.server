...
// Last Modified On : 2015-04-09  7:13 AM
// ***********************************************************************
// <copyright file="ValidateCoder.cs" company="Shanghai Yuyi">
...
namespace Infrastructure.Lib.VerifyCode
{
    /// <summary>
    ///     验证码类型
    /// </summary>
    ...
    public class ValidateCoder
    {
        ...
        ///     获取指定长度的验证码图片
        /// </summary>
        public Bitmap CreateImage(int length, out string code, int imageWidth, ValidateCodeType codeType = ValidateCodeType.Number)
        {
            if (length <= 0)
            {
                code = null;
