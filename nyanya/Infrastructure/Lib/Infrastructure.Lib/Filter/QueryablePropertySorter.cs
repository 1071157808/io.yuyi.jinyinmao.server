...
using Infrastructure.Lib.Properties;

namespace Infrastructure.Lib.Filter
{
    /// <summary>
    ...
    public static class QueryablePropertySorter<T>
    {
        ...
        private static LambdaExpression GetKeySelector(string keyName)
        {
            ...
            foreach (string propertyName in propertyNames)
            {
                ...
                if (property == null)
                {
                    throw new Exception(string.Format(Resources.ObjectExtensions_PropertyNameNotExistsInType, type.FullName, propertyName));
                }
