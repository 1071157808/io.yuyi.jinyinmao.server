// FileInformation: nyanya/Infrastructure.Lib/Ensure.cs
// CreatedTime: 2014/06/11   3:23 PM
// LastUpdatedTime: 2014/07/06   5:30 PM
...
namespace Infrastructure.Lib.Utility
{
    ...
    public static class Ensure
    {
        ...
        {
            That(left.IsNotNull() && right.IsNotNull() && left.Equals(right), message);
        }
        ...
        {
            That<TException>(value.IsNotNullOrEmpty(), message);
        }
