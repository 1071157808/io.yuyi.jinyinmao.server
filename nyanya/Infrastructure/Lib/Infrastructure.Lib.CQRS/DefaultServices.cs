// FileInformation: nyanya/Infrastructure.Lib.CQRS/DefaultServices.cs
// CreatedTime: 2014/06/30   2:14 PM
// LastUpdatedTime: 2014/07/03   11:28 PM
...
namespace Infrastructure.Lib.CQRS
{
    ...
    {
        private readonly CqrsConfigration configuration;
        ...
        public DefaultServices(CqrsConfigration configuration)
        {
            Argument.NotNull(configuration);
            this.configuration = configuration;
            CommandLogStore t = new CommandLogStore();
            ...
            this.SetSingle<ICommandLogStore>(new CommandLogStore());
